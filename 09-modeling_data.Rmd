...
```{r modeling-04, fig.cap="Probability is the area under the curve of the density"}
...
```{r modeling-05, fig.cap="Likelihood is a particular value."}
point = 0
param_mean = 1
param_sd = 1
...
```{r modeling-06, fig.cap="Relationship between density and cumulative probability distribution."}
...
```{r modeling-07, fig.cap="The density is the first derivative of the cumulative probability distribution. The likelihood is the value of the slope in the cumulative probability distribution."}
...
```{r modeling-08, fig.cap="The relative likelihood of two observations is the same as the relative probability of two areas under the curve as the margin of these areas goes to 0."}
margin = 0.1
point_blue = -1
point_red = 0
