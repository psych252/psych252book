...
Let's visualize what the posterior for the different parameters looks like. We use the `stat_halfeyeh()` function from the "tidybayes" package to do so: 
...
# anim_save("figures/sleep_posterior_predictive.gif")
```
