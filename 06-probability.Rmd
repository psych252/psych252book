...
```{r probability-3, echo=FALSE, fig.cap="Drawing two marbles out of an urn __with__ replacement."}
grViz("
digraph dot{
...
```{r probability-4, echo=FALSE, fig.cap="Drawing two marbles out of an urn __without__ replacement."}
grViz("
digraph dot{
...
```{r probability-5,fig.cap='A demonstration of the law of large numbers.'}
