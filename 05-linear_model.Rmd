...
TODO: illustrate how these can be estimated via bootstrap 
...
#   tidy() %>% 
#   clean_names() %>% 
#   left_join(confint(fit, level = 0.95) %>% 
#               as.data.frame() %>% 
#               rownames_to_column("term"),
#             by = "term") %>% 
#   mutate(cf_low = estimate + std_error * qt(0.025, df = nobs(fit)-1),
#          cf_high = estimate + std_error * qt(0.975, df = nobs(fit)-1),
#          stat = estimate / std_error,
#          p = dt(stat, df = nobs(fit))*2
#          )
```
