...
3. a `values_to` argument which specifies the name of the columh which will contain the values that were spread across different columns in the original data frame
...
Here is a slightly more advanced example that involves reshaping a data frame. Let's consider the following data frame to start with: 
