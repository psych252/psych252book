...
```{r visualization2-06, echo=FALSE, fig.align="center", out.width="90%", fig.cap="Finally a pie chart that makes sense.", out.width="95%"}
...
```{r visualization2-11, echo=FALSE, fig.cap="Box plot distributions. Source: https://www.autodeskresearch.com/publications/samestats", out.width="95%"}
...
```{r visualization2-12, echo=FALSE, fig.cap="Boxplot distributions. Source: https://www.autodeskresearch.com/publications/samestats", out.width="95%"}
...
```{r visualization2-15} 
set.seed(1)
data = tibble(rating = sample(x = 1:7, prob = c(0.1, 0.4, 0.1, 0.1, 0.2, 0, 0.1),
                              size = 500,
                              replace = T))
...
```{r visualization2-18, practice-plot5, echo=FALSE, fig.cap='Practice plot 5.', out.width="95%"}
...
```{r visualization2-21} 
ggplot(data = df.diamonds,
       mapping = aes(x = color, y = clarity, z = carat)) +
...
```{r visualization2-35, interval=1/60, results='hold', cache=TRUE, message=FALSE, warning=FALSE}
ggplot(gapminder,
...
```{r visualization2-37, fig.cap="Enable code snippets.", out.width="95%"}
...
- [shiny](figures/cheatsheets/shiny.pdf) --> interactive plots 
...
- [gganimate cheatsheet](figures/cheatsheets/gganimate.pdf) --> information about the `gganimate` package
