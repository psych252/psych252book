...
df.plot = df.dependence %>% 
  pivot_longer(names_to = "condition", values_to = "value", cols = -participant) %>% 
...
- [Quick intro to mixed effects models using lme4 and tidyverse](https://m-clark.github.io/mixed-models-with-R/)
- [Simulating Data for Mixed effects models](https://debruine.github.io/tutorials/sim-lmer.html)
