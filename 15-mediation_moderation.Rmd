...
```{r mediation-moderation-01, echo=FALSE, eval=FALSE, include=FALSE}
install.packages(c("mediation", "multilevel", "rsvg", "DiagrammeRsvg"))
```

```{r mediation-moderation-02, message=FALSE}
...
```{r mediation-moderation-04, warning=F, message=F}
g = grViz("
digraph neato {
...
```{r mediation-moderation-05, warning=F, message=F}
g = grViz("
digraph neato {
...
```{r mediation-moderation-06, warning=F, message=F}
g = grViz("
graph neato {
...
```{r mediation-moderation-07, warning=F, message=F}
g = grViz("
graph neato {
...
```{r mediation-moderation-08, warning=F, message=F}
g = grViz("
digraph neato {
...
```{r mediation-moderation-10, warning=F, message=F}
g = grViz("
graph neato {
...
```{r mediation-moderation-22, echo=FALSE, out.width="75%", fig.cap="__Basic mediation model__. c = the total effect of X on Y; c = c’ + ab; c’ = the direct effect of X on Y after controlling for M; c’ = c - ab; ab = indirect effect of X on Y."}
...
```{r mediation-moderation-31, echo=FALSE, out.width="75%", fig.cap="__Basic moderation model__."}
...
```{r mediation-moderation-33}
# scale the predictors 
df.moderation = df.moderation %>%
  mutate(across(c(x, z), ~ scale(.)[,]))
