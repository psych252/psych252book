...
```{r simulation1-38, warning=FALSE}
...
```{r simulation1-39, warning=FALSE}
...
```{r simulation1-40, echo=FALSE, out.width='90%', fig.cap="QQ plots indicating different deviations from normality."}
...
- [Simulating data](https://aosmith.rbind.io/2018/08/29/getting-started-simulating-data/)
